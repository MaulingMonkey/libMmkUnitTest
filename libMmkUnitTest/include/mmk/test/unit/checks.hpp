...
#define MMK_UNIT_TEST_ASSERT_FMT(condition, format, ...)       ZMMK_UNIT_TEST_WARN_PUSH_FMT() ((ZMMK_UNIT_TEST_BEGIN_FMT("ASSERT_FMT(%s, ...): " format,         #condition,   __VA_ARGS__),(condition))   ? (ZMMK_UNIT_TEST_PASS_FMT("ASSERT_FMT(%s, ...): " format,         #condition,   __VA_ARGS__),true) : (ZMMK_UNIT_TEST_FAIL_FMT("ASSERT_FMT(%s, ...): " format,         #condition,   __VA_ARGS__),false)) ZMMK_UNIT_TEST_WARN_POP()
#define MMK_UNIT_TEST_ASSERT_MSG(condition, message)           ZMMK_UNIT_TEST_WARN_PUSH_FMT() ((ZMMK_UNIT_TEST_BEGIN_FMT("ASSERT_MSG(%s, ...): %s",              #condition,   message    ),(condition))   ? (ZMMK_UNIT_TEST_PASS_FMT("ASSERT_MSG(%s, ...): %s",              #condition,   message    ),true) : (ZMMK_UNIT_TEST_FAIL_FMT("ASSERT_MSG(%s, ...): %s",              #condition,   message    ),false)) ZMMK_UNIT_TEST_WARN_POP()
#define MMK_UNIT_TEST_ASSERT(condition)                        ZMMK_UNIT_TEST_WARN_PUSH_FMT() ((ZMMK_UNIT_TEST_BEGIN_FMT("ASSERT(%s): ...",                      #condition               ),(condition))   ? (ZMMK_UNIT_TEST_PASS_FMT("ASSERT(%s): Passed",                   #condition               ),true) : (ZMMK_UNIT_TEST_FAIL_FMT("ASSERT_(%s): Failed",                  #condition               ),false)) ZMMK_UNIT_TEST_WARN_POP()
#define MMK_UNIT_TEST_ASSERT_CMP_FMT(a, cmp, b, format, ...)   ZMMK_UNIT_TEST_WARN_PUSH_FMT() ((ZMMK_UNIT_TEST_BEGIN_FMT("ASSERT_CMP_FMT(%s%s%s, ...): " format, #a, #cmp, #b, __VA_ARGS__),((a) cmp (b))) ? (ZMMK_UNIT_TEST_PASS_FMT("ASSERT_CMP_FMT(%s%s%s, ...): " format, #a, #cmp, #b, __VA_ARGS__),true) : (ZMMK_UNIT_TEST_FAIL_FMT("ASSERT_CMP_FMT(%s%s%s, ...): " format, #a, #cmp, #b, __VA_ARGS__),false)) ZMMK_UNIT_TEST_WARN_POP()
#define MMK_UNIT_TEST_ASSERT_CMP_MSG(a, cmp, b, message)       ZMMK_UNIT_TEST_WARN_PUSH_FMT() ((ZMMK_UNIT_TEST_BEGIN_FMT("ASSERT_CMP_MSG(%s%s%s, ...): %s",      #a, #cmp, #b, message    ),((a) cmp (b))) ? (ZMMK_UNIT_TEST_PASS_FMT("ASSERT_CMP_MSG(%s%s%s, ...): %s",      #a, #cmp, #b, message    ),true) : (ZMMK_UNIT_TEST_FAIL_FMT("ASSERT_CMP_MSG(%s%s%s, ...): %s",      #a, #cmp, #b, message    ),false)) ZMMK_UNIT_TEST_WARN_POP()
#define MMK_UNIT_TEST_ASSERT_CMP(a, cmp, b)                    ZMMK_UNIT_TEST_WARN_PUSH_FMT() ((ZMMK_UNIT_TEST_BEGIN_FMT("ASSERT_CMP(%s%s%s, ...): ...",         #a, #cmp, #b             ),((a) cmp (b))) ? (ZMMK_UNIT_TEST_PASS_FMT("ASSERT_CMP(%s%s%s): Passed",           #a, #cmp, #b             ),true) : (ZMMK_UNIT_TEST_FAIL_FMT("ASSERT_CMP(%s%s%s): Failed",           #a, #cmp, #b             ),false)) ZMMK_UNIT_TEST_WARN_POP()
